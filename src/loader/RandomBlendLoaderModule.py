...
class RandomBlendLoaderModule(LoaderInterface):
    """
    This class provides functionality to load entities from a set of .blend files. A .blend file is a
    ...
    .. code-block:: yaml
        ...
        {
          "module": "loader.BlendSetLoader",
          "config": {
            "directory": "/directory",               #<-------- path to a directory containing .blend files
    ...
    **Configuration**:
    ...
    def run(self):
        newly_loaded_objects = BlendLoader.load_random_from_directory(
